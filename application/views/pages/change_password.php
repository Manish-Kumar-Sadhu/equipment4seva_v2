...
<div class="container" >
	...
	?>
	<?php echo form_open('home/change_password',array('role'=>'form','class'=>'form-horizontal','id'=>'change_password')); ?>
	<div class="card w-100">
		...
		<div class="col-md-12">
				<button class="btn btn-md btn-info btn-block" type="submit" value="submit">Submit</button>
		</div>
        <br>
	</div>	
	</form>
